...
const startStr = '// --- Page 2 and beyond (Iterating through KPI charts to prevent cutting) ---';
const endStr = '                pdf.save(`${ticker}_Fair_Value_Report.pdf`);';
...
const replacement = `// --- Page 2 and beyond (Iterating to prevent cutting) ---
                pdf.addPage();
...
fs.writeFileSync('pdf-export.js', newContent);
console.log("Successfully replaced block in pdf-export.js");
