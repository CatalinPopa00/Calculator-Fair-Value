...
def calculate_dcf(fcf: float, growth_rate: float, discount_rate: float, perpetual_growth: float, shares_outstanding: int, total_cash: float = 0, total_debt: float = 0, years: int = 5, buyback_rate: float = 0.0, exit_multiple: float = 15.0, current_price: float = None):
    ...
    """
    if not shares_outstanding or not fcf:
        return None
...
def calculate_dcf_sensitivity(fcf: float, growth_rate, shares_outstanding: int, total_cash: float = 0, total_debt: float = 0, years: int = 5, base_discount: float = 0.09, base_perp: float = 0.02, exit_multiple: float = 15.0):
    """
...
def calculate_reverse_dcf(current_price: float, fcf: float, discount_rate: float, perpetual_growth: float, shares_outstanding: int, total_cash: float = 0, total_debt: float = 0, years: int = 5, exit_multiple: float = 15.0):
    """
    Finds implied growth for Perpetual Growth scenario.
    """
    if not all([current_price, fcf, shares_outstanding]):
        return None
    ...
    for _ in range(30):
        mid = (low + high) / 2
        res = calculate_dcf(fcf, mid, discount_rate, perpetual_growth, shares_outstanding, total_cash, total_debt, years, exit_multiple=exit_multiple)
