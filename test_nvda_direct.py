...
if len(cols) >= 2:
    ...
    curr = {
        ...
        "securities": get_val(bs, ['Available For Sale Securities', 'Other Short Term Investments', 'Other Investments', 'Investmentin Financial Assets', 'Long Term Equity Investment', 'Investments And Advances'], col_curr, default=0.0)
    }
    prev = {
        ...
        "securities": get_val(bs, ['Available For Sale Securities', 'Other Short Term Investments', 'Other Investments', 'Investmentin Financial Assets', 'Long Term Equity Investment', 'Investments And Advances'], col_prev, default=0.0)
    }
